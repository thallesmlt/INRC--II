...
public:
  ...
  BRKGA(int, int, double, double, double, vector<string>, string, int, MTRand);
  ...
  vector<vector<pair<double, double>>> ciclo_evolutivo_ponderado();
  ...
  int multi_start(int &iteracoes_max);
